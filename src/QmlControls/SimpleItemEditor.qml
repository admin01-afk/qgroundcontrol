    ...
    Column {
        ...
        ColumnLayout {
            ...
            QGCTabBar {
                ...
                QGCTabButton { icon.source: "/res/PlanSimpleItemBasic.svg"; icon.height: ScreenTools.defaultFontPixelHeight }
                QGCTabButton { icon.source: "/res/PlanSimpleItemCamera.svg"; icon.height: ScreenTools.defaultFontPixelHeight }
                QGCTabButton { icon.source: "/res/PlanSimpleItemAdvanced.svg"; icon.height: ScreenTools.defaultFontPixelHeight }
            }
            ...
            CameraSection {
                ...
                visible: missionItem.cameraSection.available && tabBar.currentIndex === 1
